...
It is specially designed for mobile devices and available for both the iOS and Android platforms.
...
* **Build** & **Upgrade** spaceship hubs and robots to improve the development of the planet. The research allows to upgrade the efficiency and performance of the robots and hubs. The process is dependent on the energy.
* **Collaboration** allows users to share the planet resources and collaborate in the development process.
